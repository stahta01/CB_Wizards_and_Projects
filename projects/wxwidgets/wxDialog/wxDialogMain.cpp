...
BEGIN_EVENT_TABLE(wxDialogDialog, wxDialog)
    EVT_CLOSE(wxDialogDialog::OnClose)
    EVT_BUTTON(idBtnQuit, wxDialogDialog::OnQuit)
    EVT_BUTTON(idBtnAbout, wxDialogDialog::OnAbout)
END_EVENT_TABLE()

wxDialogDialog::wxDialogDialog(wxDialog *dlg, const wxString &title)
...
wxDialogDialog::~wxDialogDialog()
{
}

void wxDialogDialog::OnClose(wxCloseEvent &event)
{
    Destroy();
}

void wxDialogDialog::OnQuit(wxCommandEvent &event)
{
    Destroy();
}

void wxDialogDialog::OnAbout(wxCommandEvent &event)
{
